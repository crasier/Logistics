...
public class ProgressBar extends Drawable implements Animatable {
    ...
    static final int COLOR_CIRCLE = 0x7fff8306;
    static final int COLOR_ARC = 0xffff8306;
...
//    private float density;
    ...
    public ProgressBar(Context context, View animExcutor) {
...
//        density = context.getResources().getDisplayMetrics().density;
        ...
        updateSizes(DEFAULT);
        setupAnimators();
        setBackgroundColor(COLOR_CIRCLE);
        setColorSchemeColors(COLOR_ARC);
        setSizeParameters(
                CIRCLE_DIAMETER - STROKE_WIDTH,
                CIRCLE_DIAMETER - STROKE_WIDTH,
                CIRCLE_DIAMETER / 2 - STROKE_WIDTH,
                STROKE_WIDTH,
                ARROW_WIDTH,
                ARROW_HEIGHT);
        showArrowOnFirstStart(false);
        setArrowScale(1.0f);
        showArrow(false);
    }
     ...
     *
     * @param size One of {@link ProgressBar.LARGE} or
     *             {@link ProgressBar.DEFAULT}
     */
    ...
    private static class Ring {
        ...
        public void draw(Canvas c, Rect bounds) {
            ...
            c.drawCircle(bounds.exactCenterX(),
                    bounds.exactCenterY(), bounds.width() / 2 - mStrokeWidth / 2, mCirclePaint);
