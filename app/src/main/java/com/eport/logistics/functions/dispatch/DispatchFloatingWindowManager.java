 ...
 * 委托单检索窗口
 * */
public class DispatchFloatingWindowManager {
    ...
    private String mNoStr, mDeleStr, mBuyerStr, mDateStartStr, mDateEndStr, mStatusStr, mBackStr;


    public DispatchFloatingWindowManager(Context context, View contentView) {
        mContext = context;
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.check_order_check:
                    ...
                    mBackStr = String.valueOf(mBack.getSelectedItemPosition() % 2);

                    if (listener != null) {
                        listener.onCheckClick(mNoStr, mDeleStr, mBuyerStr, mDateStartStr, mDateEndStr, mStatusStr, mBackStr);
                    }
                    break;
