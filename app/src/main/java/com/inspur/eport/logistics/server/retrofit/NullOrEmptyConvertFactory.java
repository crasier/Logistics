...
import com.inspur.eport.logistics.server.Entity.NoBodyEntity;
...
public class NullOrEmptyConvertFactory extends Converter.Factory {
    ...
    public static final NullOrEmptyConvertFactory create() {
        return new NullOrEmptyConvertFactory();
    }

    private NullOrEmptyConvertFactory() {
    }
